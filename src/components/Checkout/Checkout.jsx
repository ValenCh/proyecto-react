...
export const Checkout = () => {
    ...
    const consultarFormulario = (e) => {
        ...
        createOrdenCompra(cliente, aux, totalPrice(), new Date().toISOString()).then(ordenCompra =>{
            toast.success(`¡Muchas gracias por contar con nosotros!, su orden de compra con el ID: ${ordenCompra.id
            ...
            <div className="container" style={{marginTop:"20px"}}>
                <form onSubmit={consultarFormulario} ref={datosFormulario}>
                    ...
                    <div className="mb-3">
                        ...
                        <input type="email" className="form-control" name="repEmail" value={verifyEmail} onChange={handleVerifyEmailChange} required/>
                    </div>
